...
#define _ITERATE_1(what, x, ...)  what(x)
#define _ITERATE_2(what, x, ...)  what(x)ISEP _ITERATE_1(what, __VA_ARGS__)
#define _ITERATE_3(what, x, ...)  what(x)ISEP _ITERATE_2(what, __VA_ARGS__)
#define _ITERATE_4(what, x, ...)  what(x)ISEP _ITERATE_3(what, __VA_ARGS__)
#define _ITERATE_5(what, x, ...)  what(x)ISEP _ITERATE_4(what, __VA_ARGS__)
#define _ITERATE_6(what, x, ...)  what(x)ISEP _ITERATE_5(what, __VA_ARGS__)
#define _ITERATE_7(what, x, ...)  what(x)ISEP _ITERATE_6(what, __VA_ARGS__)
#define _ITERATE_8(what, x, ...)  what(x)ISEP _ITERATE_7(what, __VA_ARGS__)
#define _ITERATE_9(what, x, ...)  what(x)ISEP _ITERATE_8(what, __VA_ARGS__)
#define _ITERATE_10(what, x, ...) what(x)ISEP _ITERATE_9(what, __VA_ARGS__)
